...
class _CalendarScreenState extends State<CalendarScreen> {
        ...
        builder: (context, workoutProvider, child) {
          ...
          return Column(
            children: [
              ...
              Container(padding: const EdgeInsets.all(16), child: _buildCalendarView(workoutProvider)),
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Text(
              '${AppLocalizations.of(context)!.getMonthName(_focusedDay.month)} ${_focusedDay.year}',
              ...
              .map(
                (day) => Expanded(
                  child: Text(
                    ...
                    style: Theme.of(
                      context,
                    ).textTheme.bodySmall?.copyWith(fontWeight: FontWeight.bold, color: Colors.grey[300]),
                  ),
                ),
              )
              .toList(),
        ...
        // Calendar grid
        ...List.generate((lastDayOfMonth.day + firstWeekday - 1) ~/ 7 + 1, (weekIndex) {
          return Row(
            children: List.generate(7, (dayIndex) {
              ...
              final hasWorkouts = day != null && workoutProvider.getWorkoutsByDate(day).isNotEmpty;
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              color: isSelected
                                  ...
                                  ? Colors.white
                                  : Colors.white,
                              fontWeight: isToday || isSelected || hasWorkouts ? FontWeight.bold : null,
                            ),
                          ),
                        ),
                        if (hasWorkouts && !isSelected)
                          Positioned(
                            ...
                            child: Container(
                              ...
                              child: const Icon(Icons.fitness_center, size: 8, color: Colors.white),
                            ),
                          ),
                      ],
                    ),
  ...
  Widget _buildWorkoutsForDay(WorkoutProvider workoutProvider) {
    ...
    if (_selectedDay == null) {
      return Center(
        child: Text('Select a day to view workouts', style: TextStyle(color: Colors.grey[300])),
      );
    }
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              l10n.noWorkoutsOnDate,
              style: Theme.of(context).textTheme.titleMedium?.copyWith(color: Colors.grey[300]),
            ),
          ],
        ),
      );
      ...
      itemBuilder: (context, index) {
        ...
        return Card(
          ...
          child: ListTile(
            ...
            subtitle: Text(l10n.createdOn(_formatDate(workout.createdAt)), style: TextStyle(color: Colors.grey[300])),
